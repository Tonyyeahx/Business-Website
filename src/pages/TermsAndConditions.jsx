  ...
  return (
    <div className="container">
      <div className="legal-content">
        ...
        <p>
          By creating an account, downloading our applications, or using our Services in any way, you acknowledge 
          that you have read, understood, and agree to be bound by these Terms and our Privacy Policy. If you do 
        ...
        <p>
          ...
          store, and process your User Content solely to provide and improve our Services.
        </p>
        ...
        <p>
          ...
          and warrant that you own or have the necessary rights to your User Content and that it does not 
        ...
        <h3>7.1 Pricing</h3>
        <p>
          Some features of our Services may require payment. All prices are subject to change with notice. 
        ...
        <p>
          ...
          automatically renew unless cancelled before the renewal date. Refunds are provided in accordance 
          with the policies of the App Store or Google Play Store.
        </p>

        <h3>7.3 Free Trials</h3>
        <p>
          We may offer free trials for certain features. If you do not cancel before the trial ends, you 
          will be charged the applicable subscription fee.
        </p>

        <h2>8. Third-Party Services</h2>
        <p>
          Our Services may integrate with or contain links to third-party services, websites, or applications. 
          We are not responsible for the content, privacy practices, or terms of these third parties. Your use 
        ...
        <p>
          <strong>Email:</strong> <a href="mailto:legal@fact-app.com" style={{ color: 'var(--primary-color)' }}>legal@fact-app.com</a><br />
          <strong>Support:</strong> <a href="mailto:support@fact-app.com" style={{ color: 'var(--primary-color)' }}>support@fact-app.com</a><br />
          <strong>Website:</strong> <a href="https://fact-app.com" style={{ color: 'var(--primary-color)' }}>https://fact-app.com</a>
        </p>

        <div style={{ marginTop: '3rem', padding: '1.5rem', backgroundColor: 'var(--bg-light)', borderRadius: '0.5rem' }}>
          <p style={{ margin: 0, color: 'var(--text-light)' }}>
            <strong>Note:</strong> These terms and conditions are designed to comply with App Store requirements 
            and general legal standards. Please consult with a legal professional to ensure they meet all 
            applicable requirements for your specific jurisdiction and use case.
          </p>
        </div>
      </div>
    </div>
