    ...
    <div className="container">
      <div className="legal-content">
        ...
        <ul>
          ...
          <li>Content you create within our applications (tasks, notes, projects)</li>
        ...
        <p>
          If you choose to connect your account with third-party services (such as cloud storage providers), 
          we may receive information from those services in accordance with their privacy policies.
        </p>
        ...
        <p>
          ...
          such as hosting, analytics, customer support, and payment processing.
        </p>
        ...
        <p>
          ...
          <a href="mailto:privacy@fact-app.com" style={{ color: 'var(--primary-color)' }}>privacy@fact-app.com</a>.
        </p>
        ...
        <p>
          Our applications and website may contain links to third-party websites or services. We are not 
        ...
        <p>
          <strong>Email:</strong> <a href="mailto:privacy@fact-app.com" style={{ color: 'var(--primary-color)' }}>privacy@fact-app.com</a><br />
        ...
        <div style={{ marginTop: '3rem', padding: '1.5rem', backgroundColor: 'var(--bg-light)', borderRadius: '0.5rem' }}>
          <p style={{ margin: 0, color: 'var(--text-light)' }}>
            <strong>Note:</strong> This privacy policy is designed to comply with major privacy regulations 
            including GDPR, CCPA, and App Store requirements. Please consult with a legal professional to 
            ensure it meets all applicable requirements for your specific jurisdiction and use case.
          </p>
        </div>
      </div>
    </div>
